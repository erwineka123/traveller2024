																												...
																												<div class="card card-warning">
																																...
																																<form action="/orders" method="POST">
																																				...
																																				<div class="card-body">
																																								...
																																								<div class="form-group row">
																																												<label for="travel_id" class="col-sm-2 col-form-label">Travel :</label>
																																												<div class="col-sm-5">
																																																<select class="form-control" id="travel" name="travel_id" required>
																																																				@if (old('travel_id'))
																																																								<option value={{ old('travel_id') }}>
																																																												{{ $travel->where('id', old('travel_id'))->first()->name }}
																																																								</option>
																																																				@else
																																																								<option disabled selected>-- Pilih Travel --</option>
																																																				@endif
																																																				@foreach ($travel as $travel)
																																																								@if ($travel->id != old('travel_id'))
																																																...
																																																@if ($errors->has('travel_id'))
																																																				<div class="invalid-feedback">
																																																								Pilih travel dengan benar!
																																																				</div>
																																																@endif
																																												</div>
																																												<div class="col-sm-5">
																																																<div class="form-group">
																																																				<select name="type_id" class="form-control" id="travel_class" required>
																																																								@if (old('type_id'))
																																																												<option value={{ old('type_id') }}>
																																																																{{ $types->where('id', old('type_id'))->first()->name }}
																																																												</option>
																																																								@else
																																																												<option selected value="">-- Pilih Kelas Travel --
																																																												</option>
																																																								@endif
																																																				...
																																																				@if ($errors->has('travel_id'))
																																																								<div class="invalid-feedback">
																																																												Pilih kelas travel dengan benar!
																																																								</div>
																																																				@endif
																																																</div>
																																												</div>
...
<script>
				...
				function init() {
								...
								const travel_class = document.getElementById("travel_class");
								...
								checkTicketButton.addEventListener('click', function() {
												fetch(
																				`/checkprice?travel_id=${travel.value}&type_id=${travel_class.value}&from_route=${pickup.value}&to_route=${destination.value}`
																)
																.then(response => {
																...
																.catch(res => {
																				ticketsShelf.innerHTML = "Tiket tidak tersedia";
																})
								});

								checkTicketButton2.addEventListener('click', function() {
												fetch(
																				`/checkprice?travel_id=${travel.value}&type_id=${travel_class.value}&from_route=${destination.value}&to_route=${pickup.value}`
																)
																.then(response => {
																				return response.json();
																})
