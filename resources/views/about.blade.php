...
@section('front-end')
				...
				<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_4.png'); width: 100%">
																								...
																								<div class="col-md-6 pl-md-5 py-5">
																												<div class="row justify-content-start pb-3">
																																<div class="col-md-12 heading-section ftco-animate">
																																				...
																																				<h2 class="mb-4">Traveller</h2>
																																				<p>Traveller didirikan pada tahun 2020, berawal dari semangat untuk menyediakan layanan transportasi antar kota yang dapat diandalkan oleh masyarakat Bandung. Dalam perjalanan awalnya, Traveller hanya melayani beberapa rute populer Bandung - Jakarta dengan menggunakan armada kecil. 
																																					Namun, berkat kepercayaan pelanggan dan dedikasi tim, Traveller dapat terus berkembang pesat. 
																																					Pada tahun 2024, Traveller memulai transformasi besar dengan menghadirkan sistem pemesanan tiket berbasis aplikasi web.</p>
																																</div>
																												</div>
																								</div>
																				</div>
																								...
																								<div class="testimony-wrap py-4">
																												<div class="text">
																																<div class="d-flex align-items-center">
																																				...
																																				<div class="pl-3">
																																								<p class="name">Adhi Suryo Nugroho Suhardjo</p>
																								...
																								<div class="testimony-wrap py-4">
																												<div class="text">
																																<div class="d-flex align-items-center">
																																				...
																																				<div class="pl-3">
																																								<p class="name"> Audrey Iydianta Athalia</p>
																					...
																					<div class="testimony-wrap py-4">
																									<div class="text">
																													<div class="d-flex align-items-center">
																																	...
																																	<div class="pl-3">
																																					<p class="name">Athayya Khalisah Putri</p>
																																					<span class="position">UI Designer</span>
																																	</div>
																													</div>
																									</div>
																								...
																								<div class="testimony-wrap py-4">
																												<div class="text">
																																<div class="d-flex align-items-center">
																																				...
																																				<div class="pl-3">
																																								<p class="name"> Ratu Bunga Sabil Janah</p>
