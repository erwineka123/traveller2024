																																								...
																																								<tbody>
																																												@foreach ($orders as $order)
																																																<tr>
																																																				...
																																																				<td>
																																																								@isset($order->ticket->travel->name)
																																																												{{ $order->ticket->travel->name }}
																																																								@else
																																																												Tidak dapat ditampilkan
																																																								@endisset
																																																																...
																																																																<div class="modal-content">
																																																																				...
																																																																				<div class="modal-body d-flex flex-column">
																																																																								@foreach ($order->complaints as $complaint)
																																																																												<div
																																																																																class="d-flex flex-row align-items-center mb-2 @if ($complaint->user->id  ?? 'Order tidak tersedia'== Auth::id()) justify-content-end @endif">
																																																																																<img src="{{ asset($complaint->user->image ?? 'Image tidak ditemukan') }}"
																																																																																				alt="{{ $complaint->user->name ?? 'Nama tidak ditemukan' }}"
																																																																																				style="max-width: 30px; max-height: 30px"
																																																																																				class="rounded-circle mx-2">

																																																																																<label
																																																																																				class="my-1">{{ $complaint->user->name ?? 'Nama tidak ditemukan'}}</label>
																																																																												</div>
																																																																												<p
